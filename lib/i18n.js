...
const translations = {
  ...
  en: {
    ...
    updateBoosters: 'Aggiorna Boosters',
    uploadBoosters: 'Carica Boosters',
    ...
    uploadFirstCoach: 'Carica Primo Allenatore',
    activeCoach: 'Allenatore Titolare',
    activeCoachInfo: 'Questo allenatore è attualmente attivo e influenza la competenza dello stile di gioco della squadra.',
    ...
    selectCoachScreenshot: 'Seleziona screenshot dell\'allenatore:',
    coachUploaded: 'Allenatore caricato',
    coachDeleted: 'Allenatore eliminato',
    coachSetActive: 'Allenatore impostato come titolare',
    informations: 'Informazioni',
    playingStyleCompetence: 'Competenza Stili di Gioco',
    trainingAffinity: 'Affinità di Allenamento',
    statBoosters: 'Booster Statistiche',
    connection: 'Collegamento',
    focalPoint: 'Punto focale',
    keyMan: 'Uomo chiave',
    coachesLink: 'Allenatori',
    coachActiveTitle: 'Allenatore Titolare',
    // Errori
    sessionExpired: 'Sessione scaduta',
    unknownError: 'Errore sconosciuto',
    coachLoadError: 'Errore caricamento allenatori',
    coachDataLoadError: 'Errore caricamento dati',
    coachSaveError: 'Errore salvataggio allenatore',
    coachUploadError: 'Errore caricamento allenatore',
    coachSetActiveError: 'Errore impostazione allenatore attivo',
    coachDeleteError: 'Errore eliminazione allenatore',
    coachExtractError: 'Errore: dati allenatore non estratti. Verifica le immagini e riprova.',
    ...
    maxTwoPhotos: 'Massimo 2 foto consentite',
    uploadCoachInstructions: 'Carica 2 screenshot: il primo con dati principali e competenze, il secondo con il collegamento (opzionale).',
    dragDropPhotos: 'Trascina qui le foto o clicca per selezionare',
    maxTwoPhotosFormat: 'Massimo 2 foto • Formati: JPG, PNG',
    mainPhoto: 'Foto principale',
    connectionPhoto: 'Collegamento',
    ...
    loadFormation: 'Carica Formazione',
    loadReserve: 'Carica Riserva',
    loadFirstReserve: 'Carica Prima Riserva',
    extractedData: 'Dati Estratti da Foto',
    dataMismatch: 'ATTENZIONE: Dati non corrispondenti!',
    ...
    clickAnotherPlayer: 'Clicca un altro giocatore per scambiare',
    selected: 'Selezionato',
    noStarters: 'Nessun titolare',
    uploadFormationFirst: 'Carica prima la formazione',
    noReserves: 'Nessuna riserva',
    uploadPlayerCards: 'Carica card giocatori per aggiungere riserve',
    // Error messages
    formationOneImageOnly: 'Per la formazione puoi caricare solo 1 immagine',
    formationAlreadyUploaded: 'Hai già caricato una foto formazione. Rimuovila prima di caricarne un\'altra.',
    formationOneImageRequired: 'Per la formazione devi caricare esattamente 1 immagine',
    maxThreeImages: 'Massimo 3 immagini consentite',
    maxThreeImagesAlready: 'Puoi caricare massimo 3 immagini. Ne hai già',
    images: 'immagini',
    warning: 'Avviso',
    playerSavedAsReserve: 'giocatore salvato come riserva',
    playersSavedAsReserves: 'giocatori salvati come riserve',
    formationExtractionFailed: 'Impossibile estrarre giocatori dalla formazione',
    playerExtractionFailed: 'Impossibile estrarre dati giocatore',
    formationExtractionError: 'Errore durante l\'estrazione formazione',
    uploadError: 'Errore durante analisi e salvataggio',
    savingPlayer: 'Salvataggio giocatore',
    savingFormation: 'Salvataggio',
    savingTitolari: 'Salvataggio {count} titolari...',
    uploadInstructions: 'Carica 1-3 screenshot giocatori eFootball. Clicca "Valida upload" per analizzare e salvare automaticamente.',
    playersSavedAsReservesCount: '{count} giocatore/i salvato/i come riserve!',
    player: 'Giocatore',
    image: 'Immagine',
    clickOrDragImage: 'Clicca o trascina immagine qui',
    formationImageFormat: 'Formati supportati: JPG, PNG | 1 immagine (formazione completa)',
    cardImageFormat: 'Formati supportati: JPG, PNG | Massimo 3 immagini (riserve)',
    invalidSession: 'Sessione non valida. Effettua nuovamente il login.',
    formationUpdated: 'Formazione aggiornata con successo!',
    swapFormationError: 'Errore scambio formazione',
    loadPlayersError: 'Errore caricamento giocatori',
    // Coaches
    coaches: 'Coaches',
