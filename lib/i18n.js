...
const translations = {
  it: {
    ...
    // Hero Points
    heroPointsBalance: 'Bilancio Hero Points',
    heroPoints: 'Hero Points',
    buyCredits: 'Compra',
    purchaseCredits: 'Compra Crediti',
    purchaseAmount: 'Importo in Euro',
    youWillReceive: 'Riceverai',
    purchase: 'Acquista',
    cancel: 'Annulla',
    processing: 'Elaborazione...',
    purchaseSuccess: 'Acquistati {amount} Hero Points!',
    purchaseError: 'Errore durante l\'acquisto',
    sessionExpired: 'Sessione scaduta. Effettua il login.',
    clickToRefresh: 'Click per aggiornare',
    lowBalance: 'Crediti bassi',
    errorLoadingBalance: 'Errore nel caricamento del bilancio',
  ...
  en: {
    ...
    // Hero Points
    heroPointsBalance: 'Hero Points Balance',
    heroPoints: 'Hero Points',
    buyCredits: 'Buy',
    purchaseCredits: 'Purchase Credits',
    purchaseAmount: 'Amount in Euros',
    youWillReceive: 'You will receive',
    purchase: 'Purchase',
    cancel: 'Cancel',
    processing: 'Processing...',
    purchaseSuccess: 'Purchased {amount} Hero Points!',
    purchaseError: 'Error during purchase',
    sessionExpired: 'Session expired. Please log in.',
    clickToRefresh: 'Click to refresh',
    lowBalance: 'Low credits',
