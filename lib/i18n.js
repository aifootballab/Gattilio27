...
export const translations = {
  it: {
    ...
    guideCountermeasuresStep4: 'Leggi analisi, aggiustamenti tattici e istruzioni; applica i suggerimenti',
    ...
    guideShowMeHowDesc: 'Tour interattivo su ogni pagina! Clicca il pulsante con la bussola in alto a destra per una guida passo-passo che evidenzia le funzioni. Disponibile su Dashboard, Formazione, Aggiungi Partita, Contromisure, Allenatori, Guida e Profilo.',
    ...
    tourDashboardAddMatchDesc: 'Wizard 5 step: carica screenshot pagelle, statistiche, aree attacco, recuperi, formazione avversaria.',
    ...
    tourMatchIntroDesc: 'Wizard in 5 step: carica screenshot pagelle, statistiche, aree attacco, recuperi palla e formazione avversaria.',
    ...
    goalUseAIRecommendations: 'Applica almeno {count} consigli dell\'IA questa settimana',
  ...
  en: {
    ...
    guideCountermeasuresStep4: 'Read analysis, tactical adjustments and instructions; apply suggestions',
    ...
    guideShowMeHowDesc: 'Interactive tour on every page! Click the compass button top-right for a step-by-step guide that highlights features. Available on Dashboard, Formation, Add Match, Countermeasures, Coaches, Guide and Profile.',
    ...
    tourDashboardAddMatchDesc: '5-step wizard: upload ratings, stats, attack areas, ball recovery and opponent formation screenshots.',
    ...
    tourMatchIntroDesc: '5-step wizard: upload player ratings, team stats, attack areas, ball recoveries and opponent formation screenshots.',
    ...
    goalUseAIRecommendations: 'Apply at least {count} AI recommendations this week',
