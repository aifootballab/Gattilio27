...
export const translations = {
  it: {
    ...
    // Informazioni IA (form domande per riassunto)
    ...
    missingDataCompleteLater: 'Se salvi comunque o inserisci solo i campi obbligatori, potrai completare il resto dopo: clicca sul giocatore (sul campo o in riserve) e nella scheda dettaglio carica le foto mancanti (Statistiche, Abilità, Booster) o modifica i dati.',
    ...
    guideCountermeasuresTitle: 'Contromisure Live',
    guideCountermeasuresDesc: 'Carica formazione avversaria, estrai dati e genera contromisure tattiche con l\'IA.',
    guideCountermeasuresStep1: 'Carica uno screenshot della formazione avversaria',
    guideCountermeasuresStep2: 'Clicca "Estrai Formazione" per analizzare',
    guideCountermeasuresStep3: 'Clicca "Genera Contromisure" per ottenere analisi e suggerimenti',
    ...
    guideClassificaDesc: 'Classifica From Zero to Hero: punti da partite, obiettivi e utilizzo IA. Consenso in Impostazioni profilo.',
    ...
    guideClassificaStep3: 'Partecipa con almeno 3 partite complete e consenso attivo',
    guideGestioneProfiloTitle: 'Gestione profilo (Hero Points)',
    guideGestioneProfiloDesc: 'Crediti residui, analisi totali, rank e classifica. Acquista crediti e consulta transazioni.',
    guideGestioneProfiloStep1: 'Visualizza crediti residui (Hero Points) e rank (Bronze/Silver/Gold/Platinum)',
    guideGestioneProfiloStep2: 'Consulta la tua posizione in classifica e lo storico mesi precedenti',
    ...
    guideDashboardStepClassifica: 'Classifica mensile: clicca per vedere posizione e punti del mese.',
    ...
    guideShowMeHowDesc: 'Tour interattivo su ogni pagina! Clicca il pulsante con la bussola in alto a destra per una guida passo-passo. Disponibile su Dashboard, Formazione, Aggiungi Partita, Contromisure, Allenatori, Guida, Profilo, Classifica e Gestione profilo.',
    ...
    tourDashboardIntroTitle: 'Benvenuto nella Dashboard',
    tourDashboardIntroDesc: 'Ti guido in pochi passi. Qui trovi panoramica squadra, obiettivi settimanali, ultime partite e navigazione rapida.',
    tourDashboardAiTitle: 'Conoscenza IA',
    tourDashboardAiDesc: 'Indica quanto l\'IA ti conosce (0–100%). Completa profilo, rosa e partite per migliorare i consigli.',
    tourDashboardTaskTitle: 'Obiettivi Settimanali',
    tourDashboardTaskDesc: 'Task personalizzati dall\'IA. Completali per tracciare i progressi e aumentare lo score.',
    tourDashboardSquadTitle: 'Panoramica Squadra',
    tourDashboardSquadDesc: 'Titolari, riserve e formazione. Vai su Gestione Formazione per modificare la rosa.',
    tourDashboardNavTitle: 'Navigazione',
    tourDashboardNavDesc: 'Link rapidi: Contromisure Live, Gestione Formazione, Allenatori, Aggiungi Partita, Guida, Profilo.',
    tourDashboardAddMatchTitle: 'Aggiungi Partita',
    tourDashboardAddMatchDesc: 'Wizard 6 step: prima Casa/Fuori, poi carica screenshot pagelle, statistiche, aree attacco, recuperi, formazione avversaria.',
    tourDashboardMatchesTitle: 'Ultime Partite',
    tourDashboardMatchesDesc: 'Clicca su una partita per dettaglio e riassunto AI. Puoi modificare il nome avversario o eliminare.',
    tourDashboardInsightsTitle: 'Insight AI',
    tourDashboardInsightsDesc: 'Formazioni e stili più usati, problemi ricorrenti. Appare dopo aver caricato diverse partite.',
    tourDashboardClassificaTitle: 'Classifica mensile',
    tourDashboardClassificaDesc: 'Punti From Zero to Hero: partite, obiettivi e utilizzo IA. Clicca per vedere la classifica completa e la tua posizione.',
    ...
    tourClassificaYourPositionDesc: 'Punti e posizione. Usa "Dettaglio punti" per vedere come vengono calcolati (partite, obiettivi, utilizzo IA, profilo).',
    tourClassificaRankingsTitle: 'Classifica',
    tourClassificaRankingsDesc: 'Podio e lista completa. Per apparire servono consenso in Impostazioni profilo e almeno 3 partite complete nel mese.',
    ...
    tourFormationUploadDesc: 'Carica uno screenshot della formazione completa (11 giocatori) o card singole per le riserve.',
    ...
    tutorialRosaCompleteLater2: 'Nella scheda puoi caricare le foto mancanti (Statistiche, Abilità, Booster) e completare il profilo in un secondo momento.',
    ...
    tutorialRosaStep1: 'Se non hai ancora una formazione: clicca "Carica Formazione" e carica uno screenshot della formazione completa (11 in campo).',
    ...
    tutorialRosaTroubleshoot3: 'Se appare "Dati mancanti": puoi "Ricarica Foto" e riprovare con un\'immagine migliore, oppure inserire nome/rating/posizione a mano e "Salva con dati manuali".',
    ...
    tourCounterIntroTitle: 'Contromisure Live',
    ...
    tourCounterUploadDesc: 'Carica uno screenshot della formazione avversaria. Poi clicca "Estrai Formazione" per analizzare.',
    tourCounterExtractedTitle: 'Formazione Estratta',
    tourCounterExtractedDesc: 'Dopo l\'estrazione vedi formazione, stile, giocatori, forza. Poi genera le contromisure.',
    ...
    aiKnowledgeDescriptionExpert: 'Abbiamo un quadro completo: i consigli sono al massimo su misura.',
    ...
    comeSalireHint: 'Partite complete, obiettivi settimanali e utilizzo dell\'IA fanno salire i tuoi Punti Coach.',
    posizione: 'Posizione',
    nickname: 'Nickname',
    ...
    entraInClassifica: 'Entra in classifica: completa almeno 1 partita questo mese (profilo e consenso attivi).',
  ...
  en: {
    ...
    guideCountermeasuresTitle: 'Countermeasures Live',
    guideCountermeasuresDesc: 'Upload opponent formation, extract data and generate tactical countermeasures with AI.',
    guideCountermeasuresStep1: 'Upload a screenshot of the opponent formation',
    guideCountermeasuresStep2: 'Click "Extract Formation" to analyze',
    guideCountermeasuresStep3: 'Click "Generate Countermeasures" for analysis and suggestions',
    ...
    guideClassificaDesc: 'From Zero to Hero leaderboard: points from matches, goals and AI usage. Consent in Profile settings.',
    ...
    guideClassificaStep3: 'Take part with at least 3 complete matches and consent enabled',
    guideGestioneProfiloTitle: 'Profile management (Hero Points)',
    guideGestioneProfiloDesc: 'Remaining credits, total analyses, rank and leaderboard. Purchase credits and view transactions.',
    guideGestioneProfiloStep1: 'View remaining credits (Hero Points) and rank (Bronze/Silver/Gold/Platinum)',
    guideGestioneProfiloStep2: 'Check your leaderboard position and previous months history',
    ...
    guideDashboardStepClassifica: 'Monthly leaderboard: click to see your position and monthly points.',
    ...
    guideShowMeHowDesc: 'Interactive tour on every page! Click the compass button top-right for a step-by-step guide. Available on Dashboard, Formation, Add Match, Countermeasures, Coaches, Guide, Profile, Leaderboard and Profile management.',
    ...
    tourDashboardIntroTitle: 'Welcome to the Dashboard',
    tourDashboardIntroDesc: 'A quick walkthrough. Here you\'ll find team overview, weekly goals, recent matches and quick navigation.',
    tourDashboardAiTitle: 'AI Knowledge',
    tourDashboardAiDesc: 'Shows how well AI knows you (0–100%). Complete profile, roster and matches to improve recommendations.',
    tourDashboardTaskTitle: 'Weekly Goals',
    tourDashboardTaskDesc: 'Personalised tasks from AI. Complete them to track progress and boost your score.',
    tourDashboardSquadTitle: 'Team Overview',
    tourDashboardSquadDesc: 'Starters, reserves and formation. Go to Formation Management to edit your roster.',
    tourDashboardNavTitle: 'Navigation',
    tourDashboardNavDesc: 'Quick links: Countermeasures Live, Formation Management, Coaches, Add Match, Guide, Profile.',
    tourDashboardAddMatchTitle: 'Add Match',
    tourDashboardAddMatchDesc: '6-step wizard: first Home/Away, then upload ratings, stats, attack areas, ball recovery and opponent formation screenshots.',
    tourDashboardMatchesTitle: 'Recent Matches',
    tourDashboardMatchesDesc: 'Click a match for details and AI summary. You can edit opponent name or delete.',
    tourDashboardInsightsTitle: 'AI Insights',
    tourDashboardInsightsDesc: 'Most-used formations and styles, recurring issues. Appears after you\'ve loaded several matches.',
    tourDashboardClassificaTitle: 'Monthly leaderboard',
    tourDashboardClassificaDesc: 'From Zero to Hero points: matches, goals and AI usage. Click to see full leaderboard and your position.',
    ...
    tourClassificaYourPositionDesc: 'Points and rank. Use "Points breakdown" to see how they are calculated (matches, goals, AI usage, profile).',
    tourClassificaRankingsTitle: 'Leaderboard',
    tourClassificaRankingsDesc: 'Podium and full list. You need consent in Profile settings and at least 3 complete matches in the month to appear.',
    ...
    tourFormationUploadDesc: 'Upload a full formation screenshot (11 players) or single player cards for reserves.',
    ...
    tutorialRosaCompleteLater2: 'On that screen you can upload missing photos (Stats, Skills, Booster) and complete the profile later.',
    ...
    tutorialRosaStep1: 'If you don\'t have a formation yet: click "Upload Formation" and upload one screenshot of the full formation (11 on pitch).',
    ...
    tutorialRosaTroubleshoot3: 'If "Missing data" appears: you can "Retry Upload" with a better image, or enter name/rating/position manually and "Save with manual data".',
    ...
    tourCounterIntroTitle: 'Countermeasures Live',
    ...
    tourCounterUploadDesc: 'Upload a screenshot of the opponent formation. Then click "Extract Formation" to analyze.',
    tourCounterExtractedTitle: 'Formation Extracted',
    tourCounterExtractedDesc: 'After extraction you see formation, style, players, strength. Then generate countermeasures.',
    ...
    formationValidationSimple: 'You are saving your squad: make sure it is the one you use in the game and that players are positioned in the correct roles. This is important for analysis.',
    back: 'Back',
    ...
    missingDataCompleteLater: 'If you save anyway or only fill the required fields, you can complete the rest later: click on the player (on the pitch or in reserves) and in the detail screen upload the missing photos (Stats, Skills, Booster) or edit the data.',
    ...
    aiKnowledgeDescriptionExpert: 'We have the full picture: advice is as tailored as it gets.',
    ...
    comeSalireHint: 'Complete matches, weekly goals and AI usage increase your Coach Points.',
    posizione: 'Position',
    nickname: 'Nickname',
    ...
    entraInClassifica: 'Get on the leaderboard: complete at least 1 match this month (profile and consent enabled).',
