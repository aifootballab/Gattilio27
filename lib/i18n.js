...
export const translations = {
  it: {
    ...
    entraInClassifica: 'Entra in classifica: completa almeno 3 partite e 1 obiettivo questo mese.',
  ...
  en: {
    ...
    entraInClassifica: 'Get on the leaderboard: complete at least 3 matches and 1 goal this month.',
