...
const SECTION_KEYWORDS = {
  'STILI DI GIOCO DEI GIOCATORI': [
    ...
    'box-to-box', 'collante', 'terzino', 'portiere', 'ruoli', 'ala prolifica', 'rapace area',
 ...
 * Euristica: parole tipiche piattaforma = piattaforma; altrimenti eFootball.
...
export function classifyQuestion(message) {
  ...
  const platformTerms = [
    ...
    'gestione formazione', 'gestione della formazione', 'formazione dove', 'come carico',
