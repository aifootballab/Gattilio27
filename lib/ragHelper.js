...
const SECTION_KEYWORDS = {
  ...
  '2. STILI DI GIOCO DEI GIOCATORI (UFFICIALI - FISSI)': [
    'stili gioco', 'stile giocatore', 'opportunista', 'punta avanzata', 'adv striker', 'senza palla',"rapace d'area", 'fulcro',
...
export function getRelevantSections(userMessage, maxChars = DEFAULT_MAX_CHARS) {
  ...
  const STILI_TITLE = '2. STILI DI GIOCO DEI GIOCATORI (UFFICIALI - FISSI)'
  return selected
    .map(s => {
...
const PERSONAL_CONTEXT_TERMS = [
  ...
  'ho vinto', 'ho perso', 'ultima partita', 'nell\'ultima', "nell'ultima",
  ...
  'difficoltà', 'mia difficoltà', 'nelle partite',
