...
const SECTION_KEYWORDS = {
  ...
  'CONTESTO VIDEOGIOCO (FONDAMENTALE)': [
    'contesto videogioco', 'card digitali', 'fisso vs modificabile', 'terminologia',
  ...
  '2. STILI DI GIOCO DEI GIOCATORI (UFFICIALI - FISSI)': [
    'stili gioco', 'stile giocatore', 'opportunista', 'senza palla', 'rapace d area', 'fulcro',
  ...
  '7. MECCANICHE DI GIOCO AVANZATE': [
    ...
    'controllo tocco', 'finte', 'dribbling precisione', 'cross', 'finta tiro', 'finta passaggio',
  ...
  '8. ABILITÀ GIOCATORI (MISTE: NATIVE FISSE + AGGIUNGIBILI)': [
    'abilità giocatore', 'programmi aggiunta abilità', 'trending',
