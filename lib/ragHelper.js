...
const SECTION_KEYWORDS = {
  ...
  'COMANDI AVANZATI': [
    ...
    'passaggio filtrante', 'cross', 'tiro', 'pressure', 'match-up', 'match up', 'r1+x', 'l1+x',
    'triggered run', 'super cancel', 'dummy runner', 'pass and run', 'crossover'
  ],
  ...
  'PLAYSTYLES GIOCATORI AVANZATI': [
    'poacher', 'target man', 'deep-lying forward', 'wide forward', 'complete forward',
    'playmaker', 'orchestrator', 'anchor man', 'hole player', 'balance centrocampo'
  ],
  ...
  'UPDATE STAMINA V5.1.0 (Cambiamenti Recentissimi)': [
    'stamina', 'acceleration', 'sistema stamina', 'gestione stamina', 'sostituzioni',
    'super-sub', 'bench management', 'timing sprint', 'degradazione stamina'
  ],
  'BUILD DEI GIOCATORI': [
  ...
  'ATTACKING PATTERNS AVANZATI': [
    'counter-attack', 'attacking patterns', 'costruzione counter', 'finalizzazione counter',
    'lettura avversario', 'patterns avversario', 'transizioni', 'trust the run'
  ],
  'PASSING AVANZATO': [
    'passing', 'passaggio', 'ground pass', 'lofted pass', 'through ball', 'chipped through',
    'one-two pass', 'pass and run', 'momentum passing', 'tipi passaggio'
  ],
  'SITUAZIONI DI GIOCO': [
  ...
  'ABILITÀ GIOCATORI': [
    'abilità', 'abilità speciali', 'skill giocatore', 'trait', 'skill moves',
    'tiro al volo', 'tiro a giro', 'tiro potente', 'punta di precisione', 'tiro acrobatico',
    'contrasto aggressivo', 'intercettazione', 'marcatura', 'colpo di testa preciso',
    'scatto', 'resistenza superiore', 'forza fisica', 'agilità superiore', 'salto',
    'passaggio al volo', 'passaggio filtrante', 'cross preciso', 'controllo al volo',
    'double touch', 'marseille turn', 'elastico', 'chop', 'sombrero flick', 'rabona',
    'scissors', 'step over', 'riflessi felini', 'presa sicura', 'uscita portiere',
    'piazzamento', 'lancio preciso', 'parata con piedi'
  ],
  ...
  'META ATTUALE E CONSIGLI BUILD': [
    'meta', 'build', 'meta attuale', 'consigli build', 'squadra meta', 'formazione meta',
    'velocità meta', 'stamina meta', 'ruoli priorità', 'caratteristiche da evitare',
    'soglie critiche', 'build difensore', 'build centrocampista', 'build attaccante'
  ],
...
const ANALYZE_MATCH_SECTION_TITLES = [
  ...
  'COMANDI AVANZATI', 'MECCANICHE DIFENSIVE AVANZATE', 'ISTRUZIONI INDIVIDUALI E SCHEMI',
  ...
  'STATISTICHE GIOCATORI', 'TIRO E FINALIZZAZIONE', 'TATTICHE AVANZATE', 'UPDATE STAMINA V5.1.0 (Cambiamenti Recentissimi)',
  'PLAYSTYLES GIOCATORI AVANZATI', 'ATTACKING PATTERNS AVANZATI', 'PASSING AVANZATO',
  'ABILITÀ GIOCATORI', 'META ATTUALE E CONSIGLI BUILD'
]
...
const COUNTERMEASURES_SECTION_TITLES = [
  ...
  'CONSIGLI TECNICI AVANZATI', 'BEST PRACTICES E CONSIGLI PRATICI', 'DRIBBLING E SKILLS',
  'CALCI PIAZZATI', 'RUOLI SPECIFICI E COMPORTAMENTI', 'SITUAZIONI DI GIOCO', 'MOVIMENTI COLLETTIVI',
  'STATISTICHE GIOCATORI', 'ABILITÀ GIOCATORI', 'TIRO E FINALIZZAZIONE', 'TATTICHE AVANZATE',
  'UPDATE STAMINA V5.1.0 (Cambiamenti Recentissimi)', 'PLAYSTYLES GIOCATORI AVANZATI', 'ATTACKING PATTERNS AVANZATI',
  'PASSING AVANZATO', 'META ATTUALE E CONSIGLI BUILD'
]
