...
/** Whitelist description credit_transactions per use_ai_recommendations (allineata a classifica: tutte le usage contano) */
const AI_USAGE_DESCRIPTIONS_WHITELIST = ['assistant-chat', 'analyze-match', 'generate-countermeasures', 'extract-formation', 'extract-match-data', 'extract-game-analysis', 'coach-feedback-chat', 'save-coach-feedback']
