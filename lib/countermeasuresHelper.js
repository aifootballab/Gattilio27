...
export function generateCountermeasuresPrompt(
  ...
  if (hasTitolariRiserve) {
    ...
    playerSuggestionsRules = `- Identifica giocatori dalla rosa ideali per contromisura. Considera Overall, Skills, Stats.`
  }
