...
${opponentText}${rosterText}${formationText}${tacticalText}${coachText}${historyText}${patternsText}${metaCountermeasures}
...
OUTPUT FORMATO JSON (STRUTTURATO):
{
  "analysis": {
    ...
    "is_meta_formation": ${metaInfo.isMeta},
    "meta_type": ${metaInfo.isMeta ? `"${metaInfo.metaType || opponentFormation.formation_name}"` : 'null'},
