...
|----|------|-----------|-------|------|
| RC-001 | Transazioni atomiche slot | **Cursor** | ⏳ | SQL + API route - Vedi CURSOR_TASKS.md Task 1.1 |
...
| RC-004 | Blocco doppi click | ✅ Kimi | ✅ | **GIÀ IMPLEMENTATO** |
...
| RM-003 | Mutazione stato React | **Cursor** | ⏳ | `match/new/page.jsx:271` - Vedi CURSOR_TASKS.md Task 2.2 |
...
| RC-004 Doppi click | 0 min | ✅ GIA FATTO |
