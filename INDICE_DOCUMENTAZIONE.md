...
### **4) `DOCUMENTAZIONE_TASK_SISTEMA.md`**
...
### **6) `DOCUMENTAZIONE_DRAG_DROP.md`**
- **Quando usarlo**: drag & drop posizioni, salvataggio layout, edge cases.

### **7) `DOCUMENTAZIONE_GUIDA_INTERATTIVA.md`**
...
### **8) `VERIFICA_ENTERPRISE_SUPABASE.md`**
...
- **Fonte di verità**: `README.md` + `DOCUMENTAZIONE_MASTER_COMPLETA.md`
