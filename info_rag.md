...
**Fonti**: Matti, otti96, Gambler_PRO, Mednasah, Community eFootball
...
**Opportunista**
- Movimento: Gioca a contatto con l'ultimo difensore
- Posizionamento: Rapace d'area che aspetta la palla in area per finalizzare
...
**Rapace d'area** (P)
- Comportamento: Sempre in agguato nell'area di rigore per finalizzare
- Movimento: Attende in area per ricevere e concludere
- Utilizzo: Finalizzatore puro in area
- Quando serve: Gioco con molti cross e palle in area

**Fulcro di gioco** (P)
- Comportamento: Protegge la palla grazie al fisico e funge da riferimento offensivo
- Movimento: Gioca con le spalle alla porta, protegge palla
- Utilizzo: Punto di riferimento per costruzione attacco
- Quando serve: Gioco posizionale e costruzione manovra

**Classico n° 10**
- Caratteristica: Playmaker che avvia gli attacchi e minimizza lo sforzo difensivo
- Movimento: Evita corse inutili per risparmiare energia
...
**Regista creativo**
- Movimento: Sfrutta le aperture difensive per creare assist
- Comportamento: Costruisce il gioco sfruttando spazi tra le linee
...
- Posizionamento: Si posiziona sulla fascia e taglia al centro per ricevere passaggi filtranti
- Movimento: Tende a tagliare verso l'interno per ricevere passaggi
- Utilizzo: Ali che cercano finalizzazione tagliando al centro
- Quando serve: Ali con buona finalizzazione che vogliono entrare in area

**Specialista di cross** (EDA/ESA/CLD/CLS)
- Comportamento: Resta sulla fascia per crossare
- Movimento: Mantiene posizione laterale per servire cross
- Utilizzo: Gioco largo con molti cross
- Quando serve: Attaccanti forti di testa in area

**Senza palla** (P/SP/TRQ)
- Comportamento: Attira i difensori per creare spazi per gli inserimenti
- Utilizzo: Crea spazi per compagni con movimenti senza palla
- Quando serve: Gioco posizionale e costruzione manovra
...
**Tra le linee** (CC/MED)
- Comportamento: Rimane arretrato, pronto a lanciare azioni offensive
- Movimento: Centrocampista che gioca tra difesa e attacco
- Utilizzo: Giocatore di raccordo che distribuisce palla
- Quando serve: Costruzione gioco da centrocampo

**Sviluppo** (CC/MED/DC)
- Comportamento: Arretra per impostare l'azione con lanci lunghi
- Movimento: Difensore che imposta da dietro
- Utilizzo: Giocatore che parte da posizione arretrata per costruire
- Quando serve: Gioco diretto con lanci lunghi

**Incontrista** (CC/MED/DC)
- Comportamento: Giocatore che respinge gli attacchi avversari con pressing aggressivo
- Movimento: Intercetta e contrasta avversari
- Utilizzo: Difesa aggressiva e riconquista palla
- Quando serve: Squadre che giocano con pressing alto

**Onnipresente** (CLD/CLS/CC/MED)
- Comportamento: Corre instancabilmente su tutto il campo, copre ogni zona
- Movimento: Presenza costante in tutte le fasi di gioco
- Utilizzo: Giocatore che copre tutto il campo
- Quando serve: Moduli che richiedono copertura totale

**Collante** (MED)
- Comportamento: Centrocampista arretrato davanti alla difesa. Utile sia in difesa che in attacco
- Movimento: Zona ristretta davanti alla difesa
- Utilizzo: Scudo difensivo e punto di partenza costruzione
- Quando serve: Proteggere difesa e impostare gioco

**Giocatore chiave** (SP/TRQ/CLD/CLS/CC)
- Comportamento: Fiuto del gol, sempre proiettato in avanti. Punta diritto alla porta quando la squadra è in attacco
- Movimento: Cerca sempre la porta, anche da posizioni arretrate
- Utilizzo: Giocatore che cerca sempre il gol
- Quando serve: Squadre che necessitano finalizzazione da centrocampo
- Nota: Le opportunità di gol aumentano con un compagno che può tenere la palla lontano dalla propria porta
...
**Frontale extra** (DC)
- Comportamento: Difensore che partecipa alla manovra offensiva e si sovrappone in fase offensiva
- Movimento: Avanza in fase offensiva per creare superiorità numerica
- Utilizzo: Difensore che contribuisce all'attacco
- Quando serve: Squadre che cercano superiorità numerica in attacco
...
- Non affidamento su IA: lettura gioco e posizioni difensori
- Richiede: anticipazione, posizionamento, reading del gioco
- Compatibilità: Funziona con tutti gli stili di gioco

**Requisiti Tecnici**
- Device responsivo essenziale per successo
- Connection stabile fondamentale
- Con lag: manual defending diventa quasi impossibile
- Se network/device scarso: NON usare manual defending

**Shadow Marking**
- Lavoro principale: NON rushare palla
- Posizionare difensore vicino attaccante SENZA pressare direttamente
...
- Mantieni controllo giocatore principale, blocchi passing lanes

**Regole Fondamentali**
- NON rush o press aggressivamente con CB
- CB: posizionamento, non pressing
- Pressa con MIDFIELDERS, non CB
- Solo tackle con CB se palla MOLTO vicina e situazione disperata
...
**Meccanica Base**
- Chiamare pressing su portatore palla mentre si controlla altro giocatore
...
- Utilizzo: Per controllare e accelerare subito
...
**Tipi di Punizione**
- Curve Free Kick: Più comune e affidabile, curva normale verso palo
- Knuckle Shot: Tiro con nocche/dorso piede, traiettoria imprevedibile
- Dipping Shot: Palla alta che scende davanti portiere
- Trivela: Curva esterna (esterno piede), skill Outside Curl richiesta
- Low Driven: Tiro basso e potente, rasoterra veloce
- Under the Wall: Rotolante sotto barriera quando salta
- Rolling Free Kick: Passaggio corto a compagno
...
**Possesso palla**
- Comportamento: Gioco costruito con passaggi corti e pazienti per mantenere il controllo
...
**Contropiede veloce**
- Comportamento: Ripartenze veloci sfruttando spazi lasciati dagli avversari
...
**Contrattacco**
- Comportamento: Attacco diretto con passaggi verticali rapidi
- Caratteristiche: Assistenza del sistema in fase difensiva, rientro automatico senza possesso
- Utilizzo: Con difesa organizzata e transizioni rapide
- Quando usare: Contro squadre che attaccano con molti giocatori

**Passaggio lungo**
- Comportamento: Strategia basata su lanci lunghi per scavalcare il pressing avversario
- Caratteristiche: Verticalità, gioco aereo
- Utilizzo: Con opportunisti e attaccanti fisici
- Quando usare: Contro difese basse

**Vie laterali**
- Comportamento: Concentrato sul coinvolgimento degli esterni per allargare la difesa avversaria
- Caratteristiche: Esterni che spingono, ampiezza
- Utilizzo: Con terzini offensivi e ali
- Quando usare: Contro difese compatte centralmente
...
**Portiere difensivo**
- Posizionamento: Preferisce restare sulla linea di porta
- Comportamento: Reattivo, non esce spesso
- Utilizzo: Per gioco conservativo
- Quando serve: Contro squadre con tiri da lontano

**Portiere offensivo**
- Posizionamento: Agisce come libero per supportare la difesa. Gioca da libero, coprendo dietro la difesa
...
**Terzino difensivo**
- Movimento: Rimane arretrato per proteggere la difesa
- Comportamento: Preferisce rimanere in posizione per compiti difensivi
- Utilizzo: Moduli che necessitano solidità difensiva
- Quando serve: Contro ali veloci avversarie

**Terzino offensivo**
- Movimento: Si unisce all'attacco nelle fasi di costruzione. Corre in profondità e si unisce all'attacco non appena fiuta l'occasione
...
- Comportamento: Si inserisce nelle azioni offensive centrali
- Movimento: Taglia verso il centro invece di rimanere sulla fascia
- Utilizzo: Terzino che partecipa al gioco centrale
- Quando serve: Moduli che necessitano supporto centrale offensivo
...
Le statistiche determinano le prestazioni dei giocatori in campo e influenzano le dinamiche di gioco.

### Statistiche Tecniche e Offensive

- **Colpo di testa**: Precisione nei colpi di testa
- **Calci da fermo**: Precisione nei calci piazzati, rigori e punizioni
- **Tiro a giro**: Capacità di imprimere effetto al pallone
- **Velocità**: Velocità massima del giocatore
- **Accelerazione**: Rapidità nel raggiungere la velocità massima
- **Potenza di tiro**: Forza del tiro del giocatore
- **Finalizzazione**: Precisione nel tiro
- **Possesso stretto**: Abilità nel cambiare direzione durante un dribbling a bassa velocità
- **Passaggio rasoterra**: Precisione nei passaggi rasoterra
- **Passaggio alto**: Precisione nei passaggi aerei
- **Dribbling**: Controllo di palla durante un dribbling in velocità
- **Controllo palla**: Controllo generale della palla, influenza stop e finte
...
- **Contrasto**: Abilità nel vincere uno scontro con un avversario
- **Aggressività**: Intensità con cui il giocatore cerca di recuperare il possesso
- **Coinvolgimento difensivo**: Inclinazione ad aiutare in fase difensiva

### Statistiche Fisiche

- **Resistenza**: Forma fisica e durata della prestazione
- **Contatto fisico**: Capacità di contenere l'avversario e mantenere l'equilibrio
- **Controllo corpo**: Abilità nel resistere ai contrasti
- **Salto**: Altezza del salto del giocatore
- **Equilibrio**: Stabilità del giocatore

### Statistiche Portieri

- **Riflessi PT**: Capacità di bloccare tiri ravvicinati
- **Estensione PT**: Copertura dell'area di porta
- **Comportamento PT**: Rapidità di risposta sul pallone
- **Presa PT**: Capacità di afferrare il pallone
- **Parata PT**: Abilità nel respingere il pallone in zone sicure

### Caratteristiche Speciali

- **Frequenza piede debole**: Frequenza di utilizzo del piede debole
- **Precisione piede debole**: Precisione nei tiri e passaggi con il piede debole
- **Forma**: Variazione della condizione fisica (es. "Incrollabile" indica una condizione stabile)
- **Resistenza infortuni**: Probabilità di subire infortuni (maggiore è il valore, minore sarà la probabilità)
...
- Utilizzo: Fondamentale per contropiede veloce
...
- Build ottimale: Alto, fisico, veloce
...
- Fisicità: 75-85
- Altezza: 175-185cm
- Importanza: Dominare contropiede veloce
- Build ottimale: Leggero, esplosivo, rapido

*Attaccante Fisico (Target Man)*
...
- Velocità + Accelerazione: Devono essere entrambe alte, bilanciamento 85/85 meglio di 95/75
- Fisicità + Altezza: Combinazione ideale 185cm+ con 80+ fisicità
- Stamina + Ruolo: Box-to-Box senza 85+ stamina = inutilizzabile
- Dribbling + Fisicità: Giocatore tecnico MA troppo leggero = perde palla facilmente

**Build vs Stile di Gioco**
- Possesso palla: Priorità tecnica, passing, stamina
- Contropiede veloce (meta attuale): Priorità velocità, accelerazione, stamina
- Pressing Alto: Priorità stamina 85+ TUTTI, velocità 80+
- Gioco Diretto: Priorità fisicità e altezza

---

## MODULI TATTICI

I moduli tattici definiscono la struttura della squadra e influenzano il comportamento collettivo.

### Moduli con 4 Difensori

- **4-3-3**: Tre centrocampisti e tre attaccanti, ideale per possesso palla e ampiezza di gioco
- **4-2-3-1**: Due mediani per copertura, tre trequartisti dietro una punta centrale
- **4-4-2**: Due linee da quattro giocatori, perfetto per equilibrio tra difesa e attacco
- **4-1-2-3**: Un mediano davanti alla difesa, due mezzali e tre attaccanti
- **4-5-1**: Densità a centrocampo, con un'unica punta di riferimento
- **4-4-1-1**: Variante del 4-4-2 con un trequartista dietro la punta centrale
- **4-2-2-2**: Due mediani, due trequartisti larghi e due punte

### Moduli con 3 Difensori

- **3-5-2**: Due punte, centrocampo folto e esterni di centrocampo che supportano la fase difensiva
- **3-4-3**: Tre attaccanti con quattro centrocampisti, usato per gioco offensivo
- **3-1-4-2**: Un mediano davanti alla difesa e quattro centrocampisti per dominare il possesso
- **3-4-1-2**: Un trequartista dietro due punte, perfetto per creazione di gioco

### Moduli con 5 Difensori

- **5-3-2**: Difesa solida con tre centrocampisti e due attaccanti, usato per contropiede
- **5-4-1**: Massima copertura difensiva con un'unica punta
- **5-2-3**: Variante offensiva con tre attaccanti e due mediani
...
- Sbilanciamento: Non lasciare zone scoperte
...
In "Squadra dei sogni" esistono 6 tipi di giocatori:

- **Trending**: Giocatori ingaggiati al massimo livello. Sono immediatamente schierabili. Valutati in base alle statistiche iniziali. L'Allenamento Posizione non è disponibile per i giocatori Trending
- **In evidenza**: Personalizzabili secondo le esigenze. Valutati in base alle statistiche iniziali e al potenziale di crescita
- **In risalto**: Personalizzabili e potenziabili. Valutati in base alle statistiche iniziali e al potenziale di crescita
- **Epico**: Giocatori con alte potenzialità di crescita. Valutati in base alle statistiche iniziali e al potenziale di crescita
- **Leggendario**: Prestazioni elevate e costanti. Valutati in base alle statistiche iniziali e al potenziale di crescita
- **Standard**: Giocatori di base, personalizzabili. Valutati in base alle statistiche iniziali e al potenziale di crescita

### Valore Giocatore (VG)

Il Valore Giocatore (VG) rappresenta una valutazione delle capacità di un giocatore e può arrivare fino a un massimo di 5 stelle (5★).

- **Giocatori Trending**: Valutati in base alle statistiche iniziali
- **Giocatori In Evidenza, In Risalto, Epico, Leggendario e Standard**: Valutati sia in base alle statistiche iniziali che al potenziale di crescita

### Squadre

**Squadra Autentica**
- Squadra preimpostata selezionabile, aggiornata con dati reali tramite aggiornamenti live

**Squadra dei Sogni**
- Permette di costruire una squadra personalizzata scegliendo giocatori e allenatori, sviluppando strategie e partecipando a eventi online
...
**Collante**
- Ruolo: Centrocampista arretrato davanti alla difesa
...
**Giocatore chiave**
- Movimento: Fiuto del gol, sempre proiettato in avanti. Punta diritto alla porta quando la squadra è in attacco
- Necessità: Compagno che può tenere la palla lontano dalla propria porta
- Ruolo: Riferimento offensivo
- Comportamento: Le opportunità di gol aumentano con un compagno che può tenere la palla lontano dalla propria porta
...
- Tracking continuo: monitoraggio performance intelligenza artificiale
